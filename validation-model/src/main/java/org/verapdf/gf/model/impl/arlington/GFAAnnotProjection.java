...
public class GFAAnnotProjection extends GFAObject implements AAnnotProjection {

	public GFAAnnotProjection(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AAnnotProjection");
	}
