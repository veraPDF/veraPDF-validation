...
public class GFANameNameTreePages extends GFAObject implements ANameNameTreePages {

	public GFANameNameTreePages(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "ANameNameTreePages");
	}
	...
	private List<ANameNameTreePagesEntry> getEntries() {
