...
public class GFAFontFileType1 extends GFAObject implements AFontFileType1 {

	public GFAFontFileType1(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AFontFileType1");
	}
