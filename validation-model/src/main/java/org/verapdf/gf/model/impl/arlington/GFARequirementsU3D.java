...
public class GFARequirementsU3D extends GFAObject implements ARequirementsU3D {

	public GFARequirementsU3D(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "ARequirementsU3D");
	}
