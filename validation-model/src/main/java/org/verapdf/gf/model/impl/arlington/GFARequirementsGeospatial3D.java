...
public class GFARequirementsGeospatial3D extends GFAObject implements ARequirementsGeospatial3D {
	...
	public GFARequirementsGeospatial3D(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "ARequirementsGeospatial3D");
	}
