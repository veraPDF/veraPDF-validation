...
public class GFAGTSm_DevExtensions extends GFAObject implements AGTSm_DevExtensions {

	public GFAGTSm_DevExtensions(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AGTSm_DevExtensions");
	}
