...
public class GFAAnnotPolyLine extends GFAObject implements AAnnotPolyLine {
	...
	public GFAAnnotPolyLine(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AAnnotPolyLine");
	}
