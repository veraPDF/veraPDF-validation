...
public class GFACIP4_BindIn extends GFAObject implements ACIP4_BindIn {

	public GFACIP4_BindIn(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "ACIP4_BindIn");
	}
