...
public class GFACatalogNumberTreePageLabelsEntry extends GFAObject implements ACatalogNumberTreePageLabelsEntry {
	...
	private List<APageLabel> getEntry() {
	...
	private List<APageLabel> getEntry1_3() {
		COSObject object = new COSObject(this.baseObject);
		if (object.getType() == COSObjType.COS_DICT) {
			List<APageLabel> list = new ArrayList<>(1);
			list.add(new GFAPageLabel((COSDictionary)object.getDirectBase(), this.parentObject, keyName));
