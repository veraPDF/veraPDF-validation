...
public class GFAAnnotRichMedia extends GFAObject implements AAnnotRichMedia {
	...
	public GFAAnnotRichMedia(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AAnnotRichMedia");
	}
	...
	private List<ARichMediaContent> getRichMediaContent1_7() {
		...
		if (object.getType() == COSObjType.COS_DICT) {
			List<ARichMediaContent> list = new ArrayList<>(1);
			list.add(new GFARichMediaContent((COSDictionary)object.getDirectBase(), this.baseObject, "RichMediaContent"));
			return Collections.unmodifiableList(list);
		}
		return Collections.emptyList();
	}
	...
	private List<ARichMediaSettings> getRichMediaSettings1_7() {
		...
		if (object.getType() == COSObjType.COS_DICT) {
			List<ARichMediaSettings> list = new ArrayList<>(1);
			list.add(new GFARichMediaSettings((COSDictionary)object.getDirectBase(), this.baseObject, "RichMediaSettings"));
			return Collections.unmodifiableList(list);
		}
		return Collections.emptyList();
	}
	...
	public COSObject getRichMediaContentValue() {
	...
	public Boolean getRichMediaSettingsHasTypeDictionary() {
		COSObject RichMediaSettings = getRichMediaSettingsValue();
		return getHasTypeDictionary(RichMediaSettings);
	}
