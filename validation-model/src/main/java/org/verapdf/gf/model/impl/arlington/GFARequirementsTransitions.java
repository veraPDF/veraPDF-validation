...
public class GFARequirementsTransitions extends GFAObject implements ARequirementsTransitions {

	public GFARequirementsTransitions(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "ARequirementsTransitions");
	}
