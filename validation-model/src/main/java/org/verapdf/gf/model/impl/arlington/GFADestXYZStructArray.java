...
public class GFADestXYZStructArray extends GFAObject implements ADestXYZStructArray {

	public GFADestXYZStructArray(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "ADestXYZStructArray");
	}
