...
public class GFAHalftoneType16 extends GFAObject implements AHalftoneType16 {
	...
	public COSObject getHeight2Value() {
		COSObject object = this.baseObject.getKey(ASAtom.getASAtom("Height2"));
		return object;
	}

	@Override
	public String getHeight2Type() {
		COSObject Height2 = getHeight2Value();
		return getObjectType(Height2);
	}

	@Override
	public Boolean getHeight2HasTypeInteger() {
		COSObject Height2 = getHeight2Value();
		return getHasTypeInteger(Height2);
	}

	@Override
	public Long getHeight2IntegerValue() {
		COSObject Height2 = getHeight2Value();
		return getIntegerValue(Height2);
	}
	...
	public COSObject getWidth2Value() {
		COSObject object = this.baseObject.getKey(ASAtom.getASAtom("Width2"));
		return object;
	}

	@Override
	public String getWidth2Type() {
		COSObject Width2 = getWidth2Value();
		return getObjectType(Width2);
	}

	@Override
	public Boolean getWidth2HasTypeInteger() {
		COSObject Width2 = getWidth2Value();
		return getHasTypeInteger(Width2);
	}

	@Override
	public Long getWidth2IntegerValue() {
		COSObject Width2 = getWidth2Value();
		return getIntegerValue(Width2);
	}
