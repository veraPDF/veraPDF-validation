...
public class GFAArrayOfPageTreeNodeKids extends GFAObject implements AArrayOfPageTreeNodeKids {

	public GFAArrayOfPageTreeNodeKids(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AArrayOfPageTreeNodeKids");
	}
	...
	private List<AArrayOfPageTreeNodeKidsEntry> getEntries1_0() {
