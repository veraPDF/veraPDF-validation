...
public class GFAShadingType7 extends GFAObject implements AShadingType7 {

	public GFAShadingType7(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AShadingType7");
	}
	...
	@Override
	public String getBitsPerFlagType() {
		COSObject BitsPerFlag = getBitsPerFlagValue();
		return getObjectType(BitsPerFlag);
	}

	@Override
	public Boolean getBitsPerFlagHasTypeInteger() {
		COSObject BitsPerFlag = getBitsPerFlagValue();
		return getHasTypeInteger(BitsPerFlag);
	}
