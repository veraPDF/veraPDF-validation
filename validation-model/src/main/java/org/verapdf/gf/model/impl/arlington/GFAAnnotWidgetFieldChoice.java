...
public class GFAAnnotWidgetFieldChoice extends GFAObject implements AAnnotWidgetFieldChoice {

	public GFAAnnotWidgetFieldChoice(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AAnnotWidgetFieldChoice");
	}
