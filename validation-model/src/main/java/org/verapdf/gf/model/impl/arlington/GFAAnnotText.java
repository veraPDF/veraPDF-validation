...
public class GFAAnnotText extends GFAObject implements AAnnotText {

	public GFAAnnotText(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AAnnotText");
	}
	...
	public COSObject getStateDefaultValue() {
		switch (StaticContainers.getFlavour()) {
			case ARLINGTON1_5:
			case ARLINGTON1_6:
			case ARLINGTON1_7:
			case ARLINGTON2_0:
				return Objects.equals(getStateModelStringTextValue(), "Marked") ? COSString.construct("Unmarked".getBytes()) : Objects.equals(getStateModelStringTextValue(), "Review") ? COSString.construct("None".getBytes()) : null;
		}
		return null;
	}
	...
	public String getStateStringTextValue() {
		COSObject State = getStateValue();
		return getStringTextValue(State);
	}

	@Override
	public Boolean getcontainsStateModel() {
		return this.baseObject.knownKey(ASAtom.getASAtom("StateModel"));
	}
	...
	@Override
	public Boolean getStateModelHasTypeStringText() {
		COSObject StateModel = getStateModelValue();
		return getHasTypeStringText(StateModel);
	}

	@Override
	public String getStateModelStringTextValue() {
		COSObject StateModel = getStateModelValue();
		return getStringTextValue(StateModel);
	}
