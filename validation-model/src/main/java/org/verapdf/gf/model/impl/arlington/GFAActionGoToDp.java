...
public class GFAActionGoToDp extends GFAObject implements AActionGoToDp {

	public GFAActionGoToDp(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AActionGoToDp");
	}
