...
public class GFARequirementsRichMedia extends GFAObject implements ARequirementsRichMedia {

	public GFARequirementsRichMedia(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "ARequirementsRichMedia");
	}
