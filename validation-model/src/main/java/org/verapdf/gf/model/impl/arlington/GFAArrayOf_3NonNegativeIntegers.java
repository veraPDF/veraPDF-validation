...
public class GFAArrayOf_3NonNegativeIntegers extends GFAObject implements AArrayOf_3NonNegativeIntegers {

	public GFAArrayOf_3NonNegativeIntegers(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AArrayOf_3NonNegativeIntegers");
	}
