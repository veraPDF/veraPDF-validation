...
public class GFAAnnotCaret extends GFAObject implements AAnnotCaret {

	public GFAAnnotCaret(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AAnnotCaret");
	}
	...
	@Override
	public Boolean getcontainsSy() {
		return this.baseObject.knownKey(ASAtom.getASAtom("Sy"));
	}

	public COSObject getSyDefaultValue() {
		switch (StaticContainers.getFlavour()) {
			case ARLINGTON1_5:
			case ARLINGTON1_6:
			case ARLINGTON1_7:
	...
	public COSObject getSyValue() {
		COSObject object = this.baseObject.getKey(ASAtom.getASAtom("Sy"));
		if (object == null || object.empty()) {
			object = getSyDefaultValue();
		}
		return object;
	}
	...
	public String getSyType() {
		COSObject Sy = getSyValue();
		return getObjectType(Sy);
	}

	@Override
	public Boolean getSyHasTypeName() {
		COSObject Sy = getSyValue();
		return getHasTypeName(Sy);
	}

	@Override
	public String getSyNameValue() {
		COSObject Sy = getSyValue();
		return getNameValue(Sy);
	}
