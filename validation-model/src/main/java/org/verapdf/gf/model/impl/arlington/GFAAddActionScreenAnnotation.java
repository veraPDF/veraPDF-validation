...
public class GFAAddActionScreenAnnotation extends GFAObject implements AAddActionScreenAnnotation {
	...
	public GFAAddActionScreenAnnotation(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AAddActionScreenAnnotation");
	}
