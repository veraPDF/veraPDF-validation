...
public abstract class GFOpMarkedContent extends GFOperator implements OpMarkedContent {
	...
	private List<CosActualText> getactualText() {
		...
		if (actualText != null && (isRealContent || !PDFFlavours.isOnlyPDFUARelatedFlavour(StaticContainers.getFlavours()))) {
	...
	private List<CosAlt> getalt() {
		...
		if (alt != null && (isRealContent || !PDFFlavours.isOnlyPDFUARelatedFlavour(StaticContainers.getFlavours()))) {
