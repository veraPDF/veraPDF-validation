...
public class GFAAnnotSound extends GFAObject implements AAnnotSound {

	public GFAAnnotSound(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AAnnotSound");
	}
	...
	public COSObject getNameDefaultValue() {
		switch (StaticContainers.getFlavour()) {
			...
			case ARLINGTON1_7:
			case ARLINGTON2_0:
				return COSName.construct("Speaker");
		}
		return null;
	}
