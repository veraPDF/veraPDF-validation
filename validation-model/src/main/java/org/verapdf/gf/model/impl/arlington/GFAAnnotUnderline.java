...
public class GFAAnnotUnderline extends GFAObject implements AAnnotUnderline {

	public GFAAnnotUnderline(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AAnnotUnderline");
	}
