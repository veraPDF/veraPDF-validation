...
public class GFARequirementsAttachment extends GFAObject implements ARequirementsAttachment {

	public GFARequirementsAttachment(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "ARequirementsAttachment");
	}
