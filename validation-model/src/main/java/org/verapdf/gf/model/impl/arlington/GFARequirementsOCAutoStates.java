...
public class GFARequirementsOCAutoStates extends GFAObject implements ARequirementsOCAutoStates {

	public GFARequirementsOCAutoStates(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "ARequirementsOCAutoStates");
	}
