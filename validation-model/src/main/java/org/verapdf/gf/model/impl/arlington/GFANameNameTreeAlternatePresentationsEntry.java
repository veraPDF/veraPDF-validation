...
public class GFANameNameTreeAlternatePresentationsEntry extends GFAObject implements ANameNameTreeAlternatePresentationsEntry {
	...
	private List<ASlideShow> getEntry() {
	...
	private List<ASlideShow> getEntry1_4() {
		COSObject object = new COSObject(this.baseObject);
		if (object.getType() == COSObjType.COS_DICT) {
			List<ASlideShow> list = new ArrayList<>(1);
			list.add(new GFASlideShow((COSDictionary)object.getDirectBase(), this.parentObject, keyName));
