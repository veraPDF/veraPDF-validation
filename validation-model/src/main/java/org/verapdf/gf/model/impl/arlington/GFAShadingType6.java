...
public class GFAShadingType6 extends GFAObject implements AShadingType6 {

	public GFAShadingType6(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AShadingType6");
	}
