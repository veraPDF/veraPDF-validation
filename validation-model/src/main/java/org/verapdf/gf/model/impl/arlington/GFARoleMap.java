...
public class GFARoleMap extends GFAObject implements ARoleMap {

	public GFARoleMap(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "ARoleMap");
	}
	...
	private List<ARoleMapEntry> getEntries1_3() {
