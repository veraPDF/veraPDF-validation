...
public class GFAMetadata extends GFAObject implements AMetadata {

	public GFAMetadata(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AMetadata");
	}
