...
public class GFAActionTransition extends GFAObject implements AActionTransition {

	public GFAActionTransition(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AActionTransition");
	}
