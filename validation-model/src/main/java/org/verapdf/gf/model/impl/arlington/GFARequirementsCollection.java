...
public class GFARequirementsCollection extends GFAObject implements ARequirementsCollection {

	public GFARequirementsCollection(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "ARequirementsCollection");
	}
