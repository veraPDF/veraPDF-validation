...
public class GFAAnnotWidgetFieldTx extends GFAObject implements AAnnotWidgetFieldTx {

	public GFAAnnotWidgetFieldTx(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AAnnotWidgetFieldTx");
	}
