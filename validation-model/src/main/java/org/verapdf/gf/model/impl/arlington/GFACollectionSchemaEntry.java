...
public class GFACollectionSchemaEntry extends GFAObject implements ACollectionSchemaEntry {
	...
	private List<ACollectionField> getEntry() {
	...
	private List<ACollectionField> getEntry1_7() {
		COSObject object = new COSObject(this.baseObject);
		if (object.getType() == COSObjType.COS_DICT) {
			List<ACollectionField> list = new ArrayList<>(1);
			list.add(new GFACollectionField((COSDictionary)object.getDirectBase(), this.parentObject, keyName));
