...
public class GFARequirements3DMarkup extends GFAObject implements ARequirements3DMarkup {

	public GFARequirements3DMarkup(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "ARequirements3DMarkup");
	}
