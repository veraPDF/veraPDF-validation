...
public class GFAActionECMAScript extends GFAObject implements AActionECMAScript {

	public GFAActionECMAScript(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AActionECMAScript");
	}
