...
public class GFARequirementsMultimedia extends GFAObject implements ARequirementsMultimedia {

	public GFARequirementsMultimedia(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "ARequirementsMultimedia");
	}
