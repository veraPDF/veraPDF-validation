...
public class GFARequirementsMarkup extends GFAObject implements ARequirementsMarkup {

	public GFARequirementsMarkup(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "ARequirementsMarkup");
	}
