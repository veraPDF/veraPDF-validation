...
public class GFANameNameTreeIDS extends GFAObject implements ANameNameTreeIDS {

	public GFANameNameTreeIDS(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "ANameNameTreeIDS");
	}
