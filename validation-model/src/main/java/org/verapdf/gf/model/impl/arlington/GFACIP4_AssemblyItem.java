...
public class GFACIP4_AssemblyItem extends GFAObject implements ACIP4_AssemblyItem {

	public GFACIP4_AssemblyItem(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "ACIP4_AssemblyItem");
	}
