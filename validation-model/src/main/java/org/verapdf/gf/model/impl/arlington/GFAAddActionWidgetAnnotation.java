...
public class GFAAddActionWidgetAnnotation extends GFAObject implements AAddActionWidgetAnnotation {
	...
	public GFAAddActionWidgetAnnotation(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AAddActionWidgetAnnotation");
	}
