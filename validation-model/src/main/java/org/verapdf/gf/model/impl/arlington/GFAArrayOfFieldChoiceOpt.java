...
public class GFAArrayOfFieldChoiceOpt extends GFAObject implements AArrayOfFieldChoiceOpt {

	public GFAArrayOfFieldChoiceOpt(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AArrayOfFieldChoiceOpt");
	}
	...
	private List<AArrayOfFieldChoiceOptEntry> getEntries1_4() {
