...
public class GFARequirementsPRC extends GFAObject implements ARequirementsPRC {

	public GFARequirementsPRC(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "ARequirementsPRC");
	}
