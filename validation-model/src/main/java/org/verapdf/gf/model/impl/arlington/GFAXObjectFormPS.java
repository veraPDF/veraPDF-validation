...
public class GFAXObjectFormPS extends GFAObject implements AXObjectFormPS {

	public GFAXObjectFormPS(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AXObjectFormPS");
	}
