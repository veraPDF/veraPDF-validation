...
public class GFAArrayOfRequirementsHandlersEntry extends GFAObject implements AArrayOfRequirementsHandlersEntry {
	...
	private List<ARequirementsHandler> getEntry() {
	...
	private List<ARequirementsHandler> getEntry1_7() {
		COSObject object = new COSObject(this.baseObject);
		if (object.getType() == COSObjType.COS_DICT) {
			List<ARequirementsHandler> list = new ArrayList<>(1);
			list.add(new GFARequirementsHandler((COSDictionary)object.getDirectBase(), this.parentObject, keyName));
