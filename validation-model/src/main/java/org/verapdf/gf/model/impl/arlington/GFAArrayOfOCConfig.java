...
public class GFAArrayOfOCConfig extends GFAObject implements AArrayOfOCConfig {

	public GFAArrayOfOCConfig(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AArrayOfOCConfig");
	}
	...
	private List<AArrayOfOCConfigEntry> getEntries1_5() {
