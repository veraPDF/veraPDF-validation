...
public class GFAArrayOfCIP4_LABColorValue extends GFAObject implements AArrayOfCIP4_LABColorValue {

	public GFAArrayOfCIP4_LABColorValue(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "AArrayOfCIP4_LABColorValue");
	}
