...
public class GFARequirementsAcroFormInteract extends GFAObject implements ARequirementsAcroFormInteract {

	public GFARequirementsAcroFormInteract(COSBase baseObject, COSBase parentObject, String keyName) {
		super(baseObject, parentObject, keyName, "ARequirementsAcroFormInteract");
	}
