...
public class GFEmbeddedFile extends GFExternal implements EmbeddedFile {
	...
	private Map<org.verapdf.pd.colors.PDColorSpace, PDColorSpace> cachedColorSpaces;
	private Set<String> transparencyCheckedSet;
	...
	private void saveStaticContainersState() {
		...
		this.transparencyCheckedSet = StaticContainers.transparencyCheckedSet;
	}
	...
	private void restoreSavedSCState() {
		...
		StaticContainers.transparencyCheckedSet = this.transparencyCheckedSet;
	}
