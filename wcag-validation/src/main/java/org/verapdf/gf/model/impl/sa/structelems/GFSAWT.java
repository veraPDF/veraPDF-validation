...
import org.verapdf.model.salayer.SAWT;
import org.verapdf.pd.structure.PDStructElem;
import org.verapdf.tools.TaggedPDFConstants;

public class GFSAWT extends GFSAStructElem implements SAWT {

    public static final String WT_STRUCTURE_ELEMENT_TYPE = "SAWT";

    public GFSAWT(PDStructElem structElemDictionary, String parentsStandardTypes) {
        super(structElemDictionary, TaggedPDFConstants.WT, WT_STRUCTURE_ELEMENT_TYPE, parentsStandardTypes);
    }
}
