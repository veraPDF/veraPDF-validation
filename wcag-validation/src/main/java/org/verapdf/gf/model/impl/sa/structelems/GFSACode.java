...
public class GFSACode extends GFSAStructElem implements SACode {
    ...
    public GFSACode(PDStructElem structElemDictionary, String parentsStandardTypes) {
        super(structElemDictionary, TaggedPDFConstants.CODE, CODE_STRUCTURE_ELEMENT_TYPE, parentsStandardTypes);
    }
}
