...
public class GFSATHead extends GFSAStructElem implements SATHead {
    ...
    public GFSATHead(PDStructElem structElemDictionary, String parentsStandardTypes) {
        super(structElemDictionary, TaggedPDFConstants.THEAD, THEAD_STRUCTURE_ELEMENT_TYPE, parentsStandardTypes);
    }
}
