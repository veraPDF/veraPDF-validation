...
import org.verapdf.model.salayer.SASub;
import org.verapdf.pd.structure.PDStructElem;
import org.verapdf.tools.TaggedPDFConstants;

public class GFSASub extends GFSAStructElem implements SASub {

    public static final String SUB_STRUCTURE_ELEMENT_TYPE = "SASub";

    public GFSASub(PDStructElem structElemDictionary, String parentsStandardTypes) {
        super(structElemDictionary, TaggedPDFConstants.SUB, SUB_STRUCTURE_ELEMENT_TYPE, parentsStandardTypes);
    }
}
