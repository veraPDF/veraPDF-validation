...
public class GFSADiv extends GFSAStructElem implements SADiv {
    ...
    public GFSADiv(PDStructElem structElemDictionary, String parentsStandardTypes) {
        super(structElemDictionary, TaggedPDFConstants.DIV, DIV_STRUCTURE_ELEMENT_TYPE, parentsStandardTypes);
    }
}
