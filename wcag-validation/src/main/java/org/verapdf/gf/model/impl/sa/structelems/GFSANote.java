...
public class GFSANote extends GFSAStructElem implements SANote {
    ...
    public GFSANote(PDStructElem structElemDictionary, String parentsStandardTypes) {
        super(structElemDictionary, TaggedPDFConstants.NOTE, NOTE_STRUCTURE_ELEMENT_TYPE, parentsStandardTypes);
    }
}
