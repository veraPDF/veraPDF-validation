...
public class GFSASect extends GFSAStructElem implements SASect {
    ...
    public GFSASect(PDStructElem structElemDictionary, String parentsStandardTypes) {
        super(structElemDictionary, TaggedPDFConstants.SECT, SECT_STRUCTURE_ELEMENT_TYPE, parentsStandardTypes);
    }
}
