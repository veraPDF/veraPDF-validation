...
import org.verapdf.model.salayer.SAWP;
import org.verapdf.pd.structure.PDStructElem;
import org.verapdf.tools.TaggedPDFConstants;

public class GFSAWP extends GFSAStructElem implements SAWP {

    public static final String WP_STRUCTURE_ELEMENT_TYPE = "SAWP";

    public GFSAWP(PDStructElem structElemDictionary, String parentsStandardTypes) {
        super(structElemDictionary, TaggedPDFConstants.WP, WP_STRUCTURE_ELEMENT_TYPE, parentsStandardTypes);
    }
}
