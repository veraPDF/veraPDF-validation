...
public class Matrix implements Cloneable {
	...
	public Matrix(COSArray array) {
        ...
        for (int i = 0; i < SIZE; i++) {
            ...
            if (d == null) {
                matrixArray = new double[] {1, 0, 0, 1, 0, 0};
                LOGGER.log(Level.WARNING,"Null real value for matrix argument at index {} in COSArray. " +
	...
	public Matrix(List<COSBase> arguments) {
        ...
        for (int i = 0; i < SIZE; i++) {
            ...
            if (d == null) {
                matrixArray = new double[] {1, 0, 0, 1, 0, 0};
                LOGGER.log(Level.WARNING,"Null real value for matrix argument at index {} in List of arguments. " +
                                "Defaulting to matrix [1,0,0,1,0,0].", i);
                return;
            }
            matrixArray[i] = d;
