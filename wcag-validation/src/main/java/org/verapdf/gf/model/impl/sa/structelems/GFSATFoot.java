...
public class GFSATFoot extends GFSAStructElem implements SATFoot {

    public static final String TFOOT_STRUCTURE_ELEMENT_TYPE = "SATFoot";

    public GFSATFoot(PDStructElem structElemDictionary, String parentsStandardTypes) {
        super(structElemDictionary, TaggedPDFConstants.TFOOT, TFOOT_STRUCTURE_ELEMENT_TYPE, parentsStandardTypes);
    }
}
