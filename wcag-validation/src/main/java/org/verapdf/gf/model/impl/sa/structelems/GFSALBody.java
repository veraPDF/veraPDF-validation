...
import org.verapdf.model.salayer.SALBody;
import org.verapdf.pd.structure.PDStructElem;
import org.verapdf.tools.TaggedPDFConstants;

public class GFSALBody extends GFSAStructElem implements SALBody {

    public static final String LBODY_STRUCTURE_ELEMENT_TYPE = "SALBody";

    public GFSALBody(PDStructElem structElemDictionary, String parentsStandardTypes) {
        super(structElemDictionary, TaggedPDFConstants.LBODY, LBODY_STRUCTURE_ELEMENT_TYPE, parentsStandardTypes);
    }
}
