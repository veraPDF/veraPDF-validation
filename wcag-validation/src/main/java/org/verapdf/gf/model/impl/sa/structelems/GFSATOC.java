...
public class GFSATOC extends GFSAStructElem implements SATOC {
    ...
    public GFSATOC(PDStructElem structElemDictionary, String parentsStandardTypes) {
        super(structElemDictionary, TaggedPDFConstants.TOC, TOC_STRUCTURE_ELEMENT_TYPE, parentsStandardTypes);
    }
}
