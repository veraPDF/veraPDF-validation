...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.30rc/job/validation-arlington/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.30rc/job/validation-arlington/ "OPF Jenkins")
