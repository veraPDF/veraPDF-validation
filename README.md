...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.26rc/job/validation-jakarta/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.26rc/job/validation-jakarta/ "OPF Jenkins")
