...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.31/job/validation/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.31/job/validation/ "OPF Jenkins")
