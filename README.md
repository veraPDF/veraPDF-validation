...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.27/job/validation-arlington/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.27/job/validation-arlington/ "OPF Jenkins")
